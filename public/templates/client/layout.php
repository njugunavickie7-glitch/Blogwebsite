...
<head>
    ...
    <title><?php echo $page_title ?? 'Dashboard'; ?> - Prime Investment Client</title>
...
<div class="desktop-sidebar">
    ...
    <ul class="sidebar-menu">
        <li>
            <a href="/Realestate/public/client/dashboard/index.php" class="<?php echo $current_page == 'index.php' && $current_dir == 'dashboard' ? 'active' : ''; ?>">
                <i class="fas fa-tachometer-alt"></i> Dashboard
            </a>
        </li>
        <li>
            <a href="/Realestate/public/client/cart/index.php" class="<?php echo $isCart ? 'active' : ''; ?>">
                <i class="fas fa-shopping-cart"></i> Cart
                <span class="cart-count" style="display:none;">0</span>
            </a>
        </li>
        <li>
            <a href="/Realestate/public/profile/client/index.php" class="<?php echo strpos($_SERVER['REQUEST_URI'], '/profile/client/') !== false ? 'active' : ''; ?>">
                <i class="fas fa-user-circle"></i> Profile
            </a>
        </li>
        <li>
            <a href="/Realestate/public/client/settings/index.php" class="<?php echo strpos($_SERVER['REQUEST_URI'], '/client/settings/') !== false ? 'active' : ''; ?>">
                <i class="fas fa-cog"></i> Settings
            </a>
        </li>
        <li>
            <a href="/Realestate/public/auth/logout.php">
...
<nav class="top-navbar">
    <div class="d-flex justify-content-between align-items-center">
        <a href="/Realestate/public/client/dashboard/index.php" class="navbar-brand">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="user-dropdown dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="/Realestate/public/profile/client/index.php">
                        <i class="fas fa-user me-2"></i> My Profile
                    </a></li>
                    <li><a class="dropdown-item" href="/Realestate/public/client/cart/index.php">
                        <i class="fas fa-shopping-cart me-2"></i> My Cart
                    </a></li>
                    <li><a class="dropdown-item" href="/Realestate/public/client/settings/index.php">
...
<div class="bottom-nav">
    <a href="/Realestate/public/client/dashboard/index.php" class="nav-item <?php echo $current_page == 'index.php' && $current_dir == 'dashboard' ? 'active' : ''; ?>">
    ...
    <a href="/Realestate/public/profile/client/index.php" class="nav-item <?php echo strpos($_SERVER['REQUEST_URI'], '/profile/client/') !== false ? 'active' : ''; ?>">
        <i class="fas fa-user-circle"></i>
        <span>Profile</span>
    </a>
    <a href="/Realestate/public/client/settings/index.php" class="nav-item <?php echo strpos($_SERVER['REQUEST_URI'], '/client/settings/') !== false ? 'active' : ''; ?>">
        <i class="fas fa-cog"></i>
        <span>Settings</span>
    </a>
    <a href="/Realestate/public/auth/logout.php" class="nav-item">
